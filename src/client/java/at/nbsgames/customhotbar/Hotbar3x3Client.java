...
public class Hotbar3x3Client implements ClientModInitializer {
  ...
  public static boolean moveUIDown(){
    return (Hotbar3x3Client.getConfig().moveUIDDown ||
       ...
       Hotbar3x3Client.getConfig().hotbarPosition == Hotbar3x3Config.HotbarPosition.BOTTOM_MIDDLE_COMPACT) && Hotbar3x3Client.getConfig().hotbarMode != Hotbar3x3Config.HotbarMode.VANILLA;
  }

  public static boolean isCompactOn(){
    return Hotbar3x3Client.getConfig().hotbarPosition == Hotbar3x3Config.HotbarPosition.BOTTOM_MIDDLE_COMPACT && Hotbar3x3Client.getConfig().hotbarMode != Hotbar3x3Config.HotbarMode.VANILLA;
  }

  public static boolean isBottomMiddle(){
    return (Hotbar3x3Client.getConfig().hotbarPosition == Hotbar3x3Config.HotbarPosition.BOTTOM_MIDDLE_COMPACT || Hotbar3x3Client.getConfig().hotbarPosition == Hotbar3x3Config.HotbarPosition.BOTTOM_MIDDLE) && Hotbar3x3Client.getConfig().hotbarMode != Hotbar3x3Config.HotbarMode.VANILLA;
  }
